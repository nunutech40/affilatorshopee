...
- cheap: hook BOLEH menyisipkan anchor harga dari RAW (contoh: 'mulai Rp49rb'), jawab dengan produk singkat, lalu kegunaan nyata dan proof; blok 💸 tetap wajib di bagian OFFER dengan harga termurah. Jika jumlah terjual tidak tersedia, gunakan rating + jumlah penilaian/review sebagai bukti sosial dengan framing yang terasa kuat—misalnya "hampir 1.000 penilaian" untuk angka 874—tetapi jangan mengubah penilaian menjadi klaim terjual. Jangan membuat persentase diskon yang tidak faktual di RAW.
