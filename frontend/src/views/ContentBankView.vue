...
<template>
  <div class="content-page">
    ...
    <section class="panel research-form">
      ...
      <div class="research-actions"><button class="button-primary" :disabled="!researchNiche && !researchQuery.trim()" @click="openResearch('top')">Buka Populer ↗</button><button class="button-secondary" :disabled="!researchNiche && !researchQuery.trim()" @click="openResearch('live')">Buka Terbaru ↗</button><button class="button-secondary" :disabled="!researchNiche && !researchQuery.trim()" @click="openResearch('images')">Buka Media ↗</button></div>
