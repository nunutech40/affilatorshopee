...
<template>
  <section class="panel">
    ...
    <div class="form-grid">
      ...
      <div class="field"><label>Content model</label><select v-model="form.content_model" class="select"><option value="">Pilih model</option><option value="capture">Captured</option><option value="cheap">Cheap</option><option value="trending">Trending</option></select></div>
