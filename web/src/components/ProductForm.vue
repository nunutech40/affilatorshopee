...
<template>
  <section class="panel">
    ...
    <div class="form-grid">
      ...
      <div class="field"><label>Content model</label><select v-model="form.content_model" class="select"><option value="">Pilih model</option><option value="capture">Capture</option><option value="cheap">Cheap / value</option></select></div>
